            ...
            <tr>
              <td className="border border-black p-2">
                ...
                <div className="space-y-2 mx-10 text-sm">
                  <div>
                    1. A donner à leur personnel les instructions définies dans
                    ce plan de prévention.
                  </div>

                  <div>
                    2. A mettre à la disposition de leur personnel des outils,
                    matériels, moyens de prévention conformes à la
                    réglementation en vigueur et faire connaître les consignes
                    liées à leur emploi.
                  </div>
                  ...
                  <div>
                    4. Obliger son personnel de se présenter au PC Incendie à
                    leur arrivée sur le site et à la personne de{" "}
                    <span className="font-semibold">
                      l’Université de Paris VIII
                    </span>{" "}
                  ...
                  <div>
                    5. A faire savoir à leur personnel que les
                    prestations/travaux seront arrêté(e)s si le consignes de
                    sécurité prévues n’étaient pas respectées.
                  </div>
