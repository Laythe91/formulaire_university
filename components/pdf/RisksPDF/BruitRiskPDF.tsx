...
export default function BruitRiskPDF({ data }: Props) {
  ...
  return (
    <>
      <div className="pdf-section">
        {/* En-tête du Risque */}
        <div
          className="bg-yellow-100 border-black border-2 flex flex-col justify-center items-center text-center uppercase mt-3 min-h-20 break-inside-avoid"
          style={{
            width: "99.8%",
          }}
        >
        ...
        <table
          className="w-full border-2 border-black border-collapse table-fixed mt-1 break-inside-avoid"
          style={{
            width: "99.8%",
          }}
        >
