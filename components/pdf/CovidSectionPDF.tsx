          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-black p-2 align-top whitespace-pre-line">
                ...
                : <br />- Se laver les mains avec du savon régulièrement prévues
                à cet effet. <br />- Prévoir des lingettes ou produits
                hydroalcooliques dans les véhicules utilitaires. <br />- Éviter
                les contacts physiques (distance minimum 1 mètre) <br />- Dans
                la mesure du possible, fournir des masques au personnel ainsi
                que des gants à usage unique jetables. <br />- Nettoyer
                régulièrement les surfaces et les lieux collectifs (tables,
                poignées...) ainsi que les équipements individuels (téléphone,
                lunettes, bouchons d’oreilles...). <br />- Tousser ou éternuer
                dans son coude et utiliser un mouchoir à usage unique et le
            ...
            <tr>
              <td className="border border-black p-2 align-top ">
                ...
                collègues ou fournisseur
              </td>
              <td className="border border-black p-2 align-top whitespace-pre-line">
                <span className="underline">Plan d’action</span> : <br />-
                Appeler le numéro vert (0800 130 000) qui donnera le protocole à
                suivre en cas d’exposition. <br />
                <span className="underline">Mesures de précaution</span> :<br />
                - Respecter les gestes barrières et les mesures d’hygiène.{" "}
                <br />- Rester à distance du personnel étranger au chantier et
                des clients.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="border border-black p-2 align-top whitespace-pre-line">
                ...
                <span className="underline">Mesures de précaution</span> :{" "}
                <br />- Mettre en œuvre un plan de continuité d’activité pour
                avoir les personnes disponibles sur le chantier. <br />-
                Surveiller le surcroît d’activité pour les collaborateurs
                présents, ce qui peut créer des situations à risques <br />-
                Déterminer des seuils de présence du personnel à partir desquels
                l’entreprise décide de transférer l’activité sur les chantiers
                les plus importants. <br />- Désigner des remplaçants et prévoir
                la formalisation des transferts de pouvoirs et compétences (sur
                la fonction programmation planification, organisation suivi…) en
                cas de vacance de fonction.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td className="border border-black p-2 align-top whitespace-pre-line">
                ...
                chantiers (transférer des collaborateurs d’un chantier à
                ’autre).
                <br />
                <span className="underline">Mesures de précaution</span> :<br />{" "}
                - Identifier toutes les opérations nécessitant des habilitations
                sur un chantier. <br />- Identifier les collaborateurs avec les
            ...
            <tr>
              ...
              <td className="border border-black p-2 align-top whitespace-pre-line">
                <span className="underline">Plan d’action</span> :<br /> -
                Revoir l’ordonnancement des tâches pour permettre l’avancement
                du chantier dans l’attente de la livraison.
                <br />
                <span className="underline">Mesures de précaution</span> :<br />{" "}
            ...
            <tr>
              ...
              <td className="border border-black p-2 align-top whitespace-pre-line">
                ...
                <span className="underline">Mesures de précaution</span> :<br />{" "}
                - Mettre en œuvre un plan de continuité d’activité afin d’avoir
                les équipements disponibles sur le chantier.
              </td>
            </tr>
            ...
            <tr>
              <td className="border border-black p-2 align-top ">
                ...
                exposant à des poussières dangereuses ou à des produits
                chimiques.
              </td>
              <td className="border border-black p-2 align-top whitespace-pre-line">
                <span className="underline">Plan d’action</span> :<br /> -
                ...
                <span className="underline">Mesures de précaution</span> :<br />{" "}
                - Anticiper l’approvisionnement des EPI obligatoires dans le
                cadre du plan de continuité d’activité.
                ...
                désinfection, entre chaque utilisation, des masques
                réutilisables (par ex. les masques à cartouche)
              </td>
            </tr>
          </tbody>
        </table>
